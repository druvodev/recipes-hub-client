...
const Hero = () => {
  return (
    <div className="h-[700px] relative rounded-b flex items-center bg-cover bg-center bg-blend-darken bg-[url('https://yti.edu/sites/default/files/styles/blogfeature_large/public/field/image/Common-Skills-Needed-to-be-a-Chef.jpg?itok=L2nowuxH')]">

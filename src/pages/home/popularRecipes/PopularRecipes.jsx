...
const PopularRecipes = () => {
  ...
  return (
    <div className="mt-16 px-5 sm:px-10">
      <h2 className="text-3xl font-bold text-center">Most popular recipes</h2>
      <p className="text-lg text-center mt-2">
        Mock Turtle's heavy sobs. Lastly, she pictured to herself that perhaps
        it was quite tired of being all alone here!' As she said to herself; 'I
        should like to see what was going on, as she could do.
      </p>
